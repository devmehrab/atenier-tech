  ...
  return (
    <div className="rounded-2xl border border-border/60 bg-card p-6 shadow-sm">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground font-medium">
            {agent ? `Verified Broker @ ${organization.name}` : `Official Brokerage Portfolio`}
          </p>
        </div>
      </div>
      ...
      <div className="mt-6 space-y-2.5 font-sans">
        ...
        {contactWhatsApp && (
          <a
            href={`https://wa.me/${contactWhatsApp.replace(/[^0-9]/g, "")}?text=${encodeURIComponent("Hello, I would like to inquire about your property listings.")}`}
            target="_blank"
