...
async function seed() {
  ...
  const orgRahman = await Organization.create({
    ...
    description:
      "Premier luxury real estate brokerage specializing in high-end residential apartments, penthouses, and bespoke commercial investments across metropolitan hubs.",
    phone: "+1 (555) 234-5678",
  ...
  await Property.create([
    {
      ...
      description:
        "An exquisitely appointed 3-bedroom residence offering floor-to-ceiling double-glazed windows, private elevator foyer, European kitchen cabinetry with integrated Miele appliances, and sweeping skyline panoramas.\n\nBuilding features include 24/7 concierge, climate-controlled indoor pool, private resident lounge, and subterranean valet parking.",
      listingType: "SALE",
    ...
    },
    {
      ...
      assignedAgent: agentSarah._id,
      title: "Executive Lakeview Penthouse",
      slug: "executive-lakeview-penthouse",
      description:
        "Soaring high above the city, this trophy duplex penthouse features private wraparound terraces, custom glass staircase, Italian marble bathrooms, and a dedicated chef's catering kitchen.\n\nEnjoy panoramic 360-degree views with world-class residential amenities.",
      listingType: "RENT",
    ...
    },
    {
      organizationId: orgRahman._id,
      createdBy: ownerRahman._id,
      title: "Prime Commercial Floor in Trade Center",
      slug: "prime-commercial-floor-in-trade-center",
      description:
    ...
    },
    {
      organizationId: orgRahman._id,
      createdBy: ownerRahman._id,
      title: "Waterfront Residence in Manhattan",
      slug: "waterfront-residence-in-manhattan",
  ...
  const orgApex = await Organization.create({
    ...
    description:
      "Global real estate brokerage connecting international investors and affluent families with coastal estates, architectural masterpieces, and commercial towers.",
    phone: "+1 (555) 456-7890",
    email: "info@apexrealty.com",
    whatsapp: "+15554567890",
    address: "100 Ocean Drive, Suite 2100",
    city: "Miami",
    country: "US",
    branding: {
      primaryColor: "#0f172a",
  ...
  await Property.create([
    {
      ...
      title: "Biscayne Bay Oceanfront Villa",
      slug: "biscayne-bay-oceanfront-villa",
      description:
        "Spectacular modern coastal compound offering 120 feet of deepwater frontage, private yacht dock, zero-edge infinity pool, and smart home technology throughout.\n\nDesigned by renowned architects with custom teak and limestone finishes.",
      listingType: "SALE",
      propertyType: "VILLA",
      status: "PUBLISHED",
      price: 2450000,
    ...
    },
    {
      organizationId: orgApex._id,
      createdBy: ownerApex._id,
      title: "High-Rise Design Loft in Brickell",
      slug: "high-rise-design-loft-in-brickell",
      description:
        "Ultra-sleek 2-bedroom corner loft in Miami's financial corridor. Features 12ft exposed concrete ceilings, floor-to-ceiling glass, Italian porcelain tile, and private sunset balcony.",
      listingType: "RENT",
      propertyType: "APARTMENT",
      status: "PUBLISHED",
      price: 3600,
      ...
      priceNegotiable: true,
      location: {
        address: "1100 Brickell Bay Drive, #2804",
        city: "Miami",
        area: "Brickell",
        country: "US",
        zipCode: "33131",
